...
namespace WebAppTb01Lab01_Alexandre.Controllers
{
    ...
    [Route("automovel/administracao/listar")]
        ...
        public async Task<IActionResult> Create([Bind("AutomovelId,Tipo,Descriçao,Marca,Disponivel,DataCadastro")] Automovel automovel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AutomovelId,Tipo,Descriçao,Marca,Disponivel,DataCadastro")] Automovel automovel)
        {
